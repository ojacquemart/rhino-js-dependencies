...
import org.rhino.js.dependencies.io.FileInfoAttribute;
...
public class JsFileVisitor implements FileInfoAttribute, NodeVisitor {
    ...
    public FileInfo toFileInfo() {
        return new FileInfo(getFunctions(), getFunctionCalls(), loc);
    }
